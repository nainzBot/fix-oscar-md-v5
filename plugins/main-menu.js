...
return conn.sendMessage(m.chat, listMessage, { quoted: fkontak, mentions: await conn.parseMention(jarot), contextInfo:{ forwardingScore: 99999, isForwarded: true }}) 
 ...
 const fcon = {
    ...
    //------------------ DOCUMENT
let gh = 'https://github.com/nainzBot?tab=repositories'
let buttonMessage= {
'document':{'url':gh},
'mimetype': 'application/pdf',
'fileName':'Bot WhatsApp By NainOfc',
...
'title': 'BOT MULTI DEVICE BY NAIN OFC',
'body':'',
'mediaType': 2,
'thumbnail': fs.readFileSync('./thumbnail.jpg'),
'sourceUrl': 'https://instagram.com/dikaaxzy_'}},
